// <copyright file="MSGraphScopeHandler.cs" company="NPS Foundation">
...
namespace Teams.Apps.Athena.Authentication
{
    ...
    public class MSGraphScopeHandler : AuthorizationHandler<MSGraphScopeRequirement>
    {
        ...
        {
            var accessToken = await this.tokenAcquisition.GetAccessTokenForUserAsync(new[] { AthenaConstants.UserReadAll });
