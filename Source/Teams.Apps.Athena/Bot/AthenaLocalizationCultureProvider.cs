// <copyright file="AthenaLocalizationCultureProvider.cs" company="NPS Foundation">
...
namespace Teams.Apps.Athena.Bot
{
    ...
    /// <summary>
    /// This provider is responsible for implementing the <see cref="IRequestCultureProvider"/> for Bot Activities
    /// received from BotFramework.
    /// </summary>
    internal sealed class AthenaLocalizationCultureProvider : IRequestCultureProvider
    {
