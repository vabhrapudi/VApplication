// <copyright file="IRepository.cs" company="NPS Foundation">
...
namespace Teams.Apps.Athena.Common.Repositories
{
        ...
        where T : TableEntity, new()
    {
        ...
        public Task<T> CreateOrUpdateAsync(T entity);
        ...
        /// <returns>A task that represents the work queued to execute.</returns>
        public Task<T> InsertOrMergeAsync(T entity);
        ...
        public Task<(IEnumerable<T>, TableContinuationToken)> GetPagedAsync(string partition = null, int? count = null, TableContinuationToken token = null);
        ...
        /// <summary>
        /// Get a filter that filters in the entities matching the incoming custom column.
        /// </summary>
        /// <param name="values">Values by which records needs to be filtered.</param>
        /// <param name="columnName">Column name for filter.</param>
        /// <returns>A filter that filters in the entities matching the incoming row keys.</returns>
        string GetCustomColumnFilter(IEnumerable<string> values, string columnName);
    }
}